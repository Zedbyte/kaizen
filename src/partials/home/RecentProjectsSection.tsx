        ...
        <>
            <section>
                <div className="flex flex-col md:flex-row relative">
                    <h1 className="text-8xl md:text-9xl font-bold">Recent <br/>Projects</h1>
                    <button
                        className="dark:bg-gray-50 dark:text-gray-800 font-medium py-2 px-4 rounded hover:bg-gray-200 transition duration-300 
                        w-auto  h-10 md:h-14 absolute bottom-20 right-0"
                    >
